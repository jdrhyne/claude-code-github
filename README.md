...
- [Why Use This?](#why-use-this)
  ...
  - [🛡️ **Safety & Quality**](#️-safety--quality)
...
- [Quick Start](#quick-start)
  ...
  - [2. Configure Your Projects](#2-configure-your-projects)
  - [3. Set Up GitHub Token](#3-set-up-github-token)
  - [4. Configure Claude Code](#4-configure-claude-code)
  - [5. Test Your Setup](#5-test-your-setup)
  - [6. Test with Claude Code](#6-test-with-claude-code)
...
- [Available Tools](#available-tools)
  ...
  - [Enhanced PR Management Tools](#enhanced-pr-management-tools)
  - [Issue Integration Tools](#issue-integration-tools)
...
- [Environment Variables](#environment-variables)
  - [Usage with Environment Variables](#usage-with-environment-variables)
